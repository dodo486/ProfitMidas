...
public enum PusanK200옵션_가격제한폭확대 implements FeedParser {
    ...
    상한가(39, 5, PacketType.Integer),
    하한가(44, 5, PacketType.Integer);

    PusanK200옵션_가격제한폭확대(int offSet, int length, PacketType type) {
