...
public enum Option_종목정보 implements FeedParser {
    ...
    productName(66, 80, PacketType.String),  //종목명(66, 80, PacketType.String),
    결제월번호(454, 3, PacketType.Integer), //결제월일련번호(454, 3, PacketType.Integer),
    matDate(457, 8, PacketType.String),  //만기일자(457, 8, PacketType.String),
    multiplier(506, 22, PacketType.Float), //거래승수(506, 22, PacketType.Float),   .xx 식의 소숫점 두자리 식으로만 파싱하게 되어있으므로 일단 블락..
    strikePrice(465, 18, PacketType.Float),  //행사가격(465, 18, PacketType.Float),
    strikePriceDisp(712, 18, PacketType.Float),  // 조회용행사가격(712, 18, PacketType.Float),
    ...
    결제주(1306, 2, PacketType.String),  // 결제주(1306, 2, PacketType.String),
