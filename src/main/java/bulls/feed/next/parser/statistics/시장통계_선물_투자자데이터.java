...
//    데이터구분(0, 2, PacketType.String), // "*전일확정 : 00, 당일잠정 : 01, 당일확정 : 02, E1 : 장중 데이터 완료, E2 : 확정 데이터 완료    최종 record '99' set"
    ...
    매수약정수량_SP(101, 10, PacketType.Integer),  //스프레드매수거래량(101, 10, PacketType.Integer),
    매도약정수량_SP(111, 10, PacketType.Integer),  //스프레드매도거래량(111, 10, PacketType.Integer),
    매수약정대금_SP(121, 22, PacketType.Float),  //스프레드매수거래대금(121, 22, PacketType.Float),
    매도약정대금_SP(143, 22, PacketType.Float);  //스프레드매도거래대금(143, 22, PacketType.Float),
